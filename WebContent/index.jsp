...
<html lang="en">
    ...
    <body>
        <!-- Begin page -->
        <div class="accountbg" style="background: url('images/pm1.jpg');background-size: cover;background-position: center;">
        	<div class="title shadow text-center">
        		<h5>Project Management System</h5>
        		<h5>Developed By: Anand Singh</h5>
        	</div>
        </div>
                    ...
                    <div class="account-box">
                        ...
                        <div class="card-box shadow-none p-4">
                            ...
                            <div class="mt-5 pt-4 text-center position-relative">
                                <p><script>document.write(new Date().getFullYear())</script> ©Project Management <i class="mdi mdi-heart text-danger"></i> by Anand</p>
                            </div>
